-- DARMS backup schema: exact copy of the app database tables for the mirror database.
-- Run in the backup project's SQL editor (https://supabase.com/dashboard/project/ntbsexvtmxdvdphcwgfl/sql).
