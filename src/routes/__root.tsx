  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4">
      <div className="max-w-md text-center">
        ...
        <a href="/dashboard" className="mt-6 inline-block text-sm font-medium text-slate-900 underline">
          Go to dashboard
        </a>
      </div>
    </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "DARMS — Physical Document Lifecycle12" },
      { name: "description", content: "Manage physical document storage, retrieval, disposal and costs." },
      { property: "og:title", content: "DARMS — Physical Document Lifecycle12" },
      { name: "twitter:title", content: "DARMS — Physical Document Lifecycle12" },
      ...
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/06a420e1-b18b-440a-96fc-7ebf917f5110/id-preview-d9ad19a6--b7f20078-ac1c-4d0d-8ef2-961176afac4e.lovable.app-1782194948952.png" },
